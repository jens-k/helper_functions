...
if nargin > 3
	warning('Make sure to doublecheck whether function deals correctly with nTarget ~= nDistract')
end
if pHit > 1 | pFA > 1 
...
if pFA < 1
    pFA = max(pFA,.5/nDistract); % was nTarget in the original function
else pFA=1-.5/nDistract; % was nTarget in the original function
end % if pFA=0
